...
Mesh Model::processMesh(aiMesh *mesh, const aiScene *scene)
{
	...
	{
		Vertex vertex;
		glm::vec3 vector = glm::vec3(1.0f); // we declare a placeholder vector since assimp uses its own vector class that doesn't directly convert to glm's vec3 class so we transfer the data to this placeholder glm::vec3 first.
		// positions
...
vector<Texture2> Model::loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName)
{
	vector<Texture2> textures;
